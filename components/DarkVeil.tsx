...
export default function DarkVeil({
  ...
  useEffect(() => {
    ...
    // Safety check if WebGL context was not created
    if (!gl) return;
    ...
    const loop = () => {
      ...
      // Ensure mesh is valid before rendering
      if (mesh) {
    ...
    return () => {
      ...
      // Removed manual context loss to avoid issues in React Strict Mode re-renders
    };
